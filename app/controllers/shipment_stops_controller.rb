class ShipmentStopsController < ApplicationController
  ...
  def shipment_stop_params
    params.require(:shipment_stop).permit(:office_id, :location_id, :driver_id, :stop_start, :stop_end, :stop_status, :stop_arrival, :stop_departure, :stop_notes, :vehicle_id, :trailer_id)
  end
end
