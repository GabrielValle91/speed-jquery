...
Rails.application.config.assets.precompile += %w( shipment_stops.js )
Rails.application.config.assets.precompile += %w( dispatch.css )
Rails.application.config.assets.precompile += %w( bol.css )
